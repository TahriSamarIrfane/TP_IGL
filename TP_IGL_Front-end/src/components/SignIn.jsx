        ...
        <div className='flex items-center justify-center h-screen w-screen bg-gradient-to-r from-GLbleu via-GLpink to-orange-300 '>
            <div className='flex flex-col md:flex-row bg-white md:h-[80%] w-[80%] md:w-[60%] rounded-2xl shadow-lg '>
                ...
                <IoClose  className='absolute text-grey text-2xl hidden md:block right-4 top-4'/>
                    ...
                    <form className='relative mt-5'>
                        <input type={showPassword ? 'text' : 'password'} 
                         ...
                         className='rounded-md w-full border-gray-300 '/>
                            ...
                            <button id='submit' type='button' onClick={togglePasswordVisibility}>
                    ...
                    {!jumpM && !jumpA && !jump &&(<p className='text-white font-bold text-lg'>Se Connecter</p>)}
                    {jump &&(<Link to='/user'><p className='text-white font-bold text-lg'>Se Connecter</p></Link>)}
                    {jumpA &&(<Link to='/Admin'><p className='text-white font-bold text-lg'>Se Connecter</p></Link>)}
                    {jumpM &&(<Link to='/Moderateur'><p className='text-white font-bold text-lg'>Se Connecter</p></Link>)}
