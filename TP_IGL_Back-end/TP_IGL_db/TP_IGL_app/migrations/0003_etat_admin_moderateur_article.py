...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('TP_IGL_app', '0002_customuser_usergroup_customuser_groups_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TP_IGL_app.admin')),
                ('etat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TP_IGL_app.etat')),
                ('moderateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TP_IGL_app.moderateur')),
            ],
        ),
    ]
