...
<<<<<<< HEAD:TP_IGL_Back-end/TP_IGL_VENV/Lib/site-packages/elasticsearch_dsl/utils.py
        """ Produce a repr of all our parameters to be used in __repr__. """
=======
        """Produce a repr of all our parameters to be used in __repr__."""
>>>>>>> e7342538b6028f7cf89a367829c6d8d84f9f9438:TP_IGL_Back-end/env/Lib/site-packages/elasticsearch_dsl/utils.py
        return ", ".join(
