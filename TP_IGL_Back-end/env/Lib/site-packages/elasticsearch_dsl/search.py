...
<<<<<<< HEAD:TP_IGL_Back-end/TP_IGL_VENV/Lib/site-packages/elasticsearch_dsl/search.py
                self, es.search(index=self._index, body=self.to_dict(), **self._params)
=======
                self, es.search(index=self._index, **params)
>>>>>>> e7342538b6028f7cf89a367829c6d8d84f9f9438:TP_IGL_Back-end/env/Lib/site-packages/elasticsearch_dsl/search.py
            )
